window.onscroll = function showHeader() {
    var div = document.getElementsByClassName('nav_link'); 
     ...
     if (window.pageYOffset > 100){
        ...
        document.getElementById("img1").src="images/Credo 11 png.png";
        document.getElementById("img111").src="images/credo1.png";
        ...
        document.getElementById("img1").src="images/Credo 22 png.png";
        document.getElementById("img111").src="images/credo/Credo_2_png-removebg-preview.png";
